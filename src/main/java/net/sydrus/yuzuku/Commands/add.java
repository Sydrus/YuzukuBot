...
public class add extends Command {
	...
	public boolean onCommand(User Sender, Message Message, Guild Guild, TextChannel Chat, List<LevelType> type,
		...
		Chat.sendMessage(embedMessage("Hello I'm " + YuzukuBot.botName + ". Add me to your discord guild at the link: https://discordapp.com/oauth2/authorize?&client_id=278693792297779200&scope=bot&permissions=66321471")).queue();;
		return true;
	}
